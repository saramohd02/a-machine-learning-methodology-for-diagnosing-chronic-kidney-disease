"""chronic_kidney_disease URL Configuration
...
from chronic_kidney_disease import settings
...
urlpatterns = [
    ...
    url(r'^Find_Kidney_Disease_Ratio/$', serviceprovider.Find_Kidney_Disease_Ratio, name="Find_Kidney_Disease_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Kidney_Disease_Positive_Details/$', serviceprovider.View_Kidney_Disease_Positive_Details, name="View_Kidney_Disease_Positive_Details"),
    url(r'^Find_Kidney_Disease_Status/$', serviceprovider.Find_Kidney_Disease_Status, name="Find_Kidney_Disease_Status"),
